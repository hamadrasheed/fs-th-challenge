...
<body>
    <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FAFAFA"
        class="full-width">
        <tbody>
            <tr>
                <td>
            ...
            <tr>
                <td align="center">
                    <table width="700" border="0" align="center" cellspacing="0" cellpadding="0"
                        bgcolor="#FFFFFF" class="full-width" style="margin:0 auto;">
                        <tbody>
                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" width="660">
                                                                    <a name="Logo" style="display:block"
                                                                        href="#">
                                                                        <img src="{{ asset('images/logotype.png') }}"
                                                                            border="0"
                                                                            style="display:block;width: 30%;margin: 1em"
                                                                            class="logo"></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top"
                                                                    ...
                                                                    <span
                                                                        style="font-size:22px; font-weight:bold; line-height:26px;">@yield('title')</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
        ...
        <tbody>
            <tr>
                <td valign="top" align="center">
                    <table width="700" border="0" align="center" cellspacing="0" cellpadding="0"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td valign="top" width="660" bgcolor="#FFFFFF" class="hide" height="40"
                                    alt="" border="0"></td>
                                <td valign="top" width="20" class="hide" bgcolor="#1a1c21">
                                    <div style="font-size:44px;line-height:44px;">&nbsp;</div>
                                </td>
                    ...
                    <table width="700" border="0" align="center" cellspacing="0" cellpadding="0"
                        bgcolor="#1a1c21" class="full-width" style="margin:0 auto;">
                        <tbody>
                            <tr>
                                <td valign="top" align="center">
                                    <table width="700" border="0" align="center" cellspacing="0"
                                        cellpadding="0" bgcolor="#1a1c21" class="full-width">
                                        <tbody>
                                            <tr>
                                                <td valign="top" align="center">
                                                    <table width="700" border="0" align="center"
                                                        cellspacing="0" cellpadding="0" bgcolor="#1a1c21"
                                                        class="full-width">
                                                        <tbody>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="center" valign="top" width="660"
                                                                    bgcolor="#1a1c21">
                                                                    <a name="Logo_1" style="display:block;"
                                                                        href="{{ env('APP_CLIENT_URL') }}"
                                                                        target="_blank">
                                                                        <img src="{{ asset('images/icon.png') }}"
                                                                            alt="logo" border="0"
                                                                            style="display:block;width: 25%;"></a>
                                                                </td>
                                                                <td valign="top" width="20" class="hide">
                                                                    &nbsp;</td>
                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <span
                                                                                                        ...
                                                                                                        {{ now()->format('Y') . ' ' . env('APP_CLIENT') }}.
                                                                                                        All rights
                                                                                                        reserved.
                                                                                                        {{-- {{ env('MIX_ADDRESS_COMPANY') }}. --}}
                                                                                                    </span>
                                                                                                    <br>
                                                                                                    <div id="stat-div"
