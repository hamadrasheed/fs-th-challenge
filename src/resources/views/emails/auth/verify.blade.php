        ...
        <tbody>
            <tr>
                <td align="center" valign="top"
                    ...
                    class="body">
                    We sent this email because we we're only need to make sure that<br>
                    email address: <b>{!! $email !!}</b> is yours. click the button below to verify. If you didn't
                    submit the request,
                ...
                <td>
                    <table width="660" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center">
                                    <span style="font-family : helvetica, arial; font-weight : bold; font-size: 16px; ">How
                                        is my account verified?</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <span class="pw-note" style="font-family: helvetica, arial;
                                                                     ...
                                                                     line-height: 22px;
                                                                     display: block;">
                                        We will not make you input certain codes.<br>Just click the
                                        link and your account will be verified.
                                    </span>
                                </td>
                            </tr>
